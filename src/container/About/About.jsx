...
const abouts = [
  {title: 'Adventurous', description: `I Love trying new things and pushing my limits to be the best verison of myself as possible (Here's me sliding down an active volcano) `, imgUrl: images.volcanBoarding },
   ...
   <>
      <h2 className='head-text'>WHO AM I & WHY I AM  <span>A GOOD FIT</span><br />FOR YOUR COMPANY <span></span></h2>
        <div className="description">
          <span>Hi. Im Daniel. Im an Aerospace Enginnering graduate with a passion for coding seeking a role as a fullstack developer.</span>  
          <span>If i could desribe myself in 4 words i would choose :</span>
        </div>
